...
def construct_parser():
    ...
    parser.add_argument('--mixture_size', default=None, type=int)
...
def main(args):
    ...
    # define the model.
    model_raw = HyperMapp3rSSN2_MIXTURE(ssn_rank=15, mixture_size=args.mixture_size).cuda()
    ...
    def gen_samples(xs3dQ, ys3dQ):
        ...
        if variant == "2":
            folder = "Xnew_ssn_mixture2_01/"
        else:
            folder = "Xnew_ssn_mixture5_01/"
