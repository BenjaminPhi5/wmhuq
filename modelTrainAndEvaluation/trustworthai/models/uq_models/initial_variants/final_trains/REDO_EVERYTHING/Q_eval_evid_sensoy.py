...
def construct_parser():
    ...
    parser.add_argument('--dice_factor', default=1, type=float)
    parser.add_argument('--xent_factor', default=0.1, type=float)
...
def main(args):
    ...
    def combined_loss(logits, target):
        ...
        return xent * xent_factor + kl * kl_factor + dice * dice_factor
    ...
    def gen_samples(xs3dQ, ys3dQ):
        ...
        if variant == "5":
            folder = "Xsensoy_evid1_d5_kl02_xent02/"
        elif variant == "x5kl1":
            folder = "Xsensoy_evid7_d5_kl01_xent05/"
        else:
            folder = "Xsensoy_evid8_d5_kl01_xent01/"
