...
def construct_parser():
    ...
    parser.add_argument('--muvariant', default=None, type=str)
...
def main(args):
    ...
    def gen_samples(xs3dQ, ys3dQ):
        ...
        folder = f"Xpunet_{fstring}dice{variant}/"
        ...
        for i in tqdm(range(len(ys3dQ)), position=0, leave=True, ncols=150):
            ...
            with torch.no_grad():
                ...
                means3d.append(model.model.sample(mean=True).squeeze().cpu()/t)
