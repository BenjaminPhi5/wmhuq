...
#SBATCH --exclude=damnii12,damnii04,damnii06
# #SBATCH --exclude=damnii08
...
scratch_dir=/disk/scratch_big/${USER}/ipdis/preprep/out_data/collated
...
result_path=/disk/scratch_big/${USER}/results/revamped_models
result_dest_path=/home/${USER}/ipdis/results/revamped_models
...
# commented this out because it buggers the logger.
#rm -rf ${result_path}/*
