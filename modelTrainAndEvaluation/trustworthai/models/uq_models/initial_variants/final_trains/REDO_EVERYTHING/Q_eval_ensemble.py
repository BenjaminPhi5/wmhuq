...
def main(args):
    ...
    def gen_samples(xs3dQ, ys3dQ):
        ...
        # accidentally only trained 19 of these.... so duplicating the last... very hacky. should be fixed. TODO.
        folders = ["Xens" + ndigit(2, x+1) + "/" for x in range(19)] + ["Xens19/"]
