...
class ProbabilisticUnet(nn.Module):
    ...
    def __init__(self, base_model, input_channels=1, num_classes=1, num_filters=[16,64,128,192], latent_dim=6, no_convs_fcomb=4, beta=10.0):
    ...
    def sample(self, testing=False, use_prior_mean=False):
        """
        Sample a segmentation by reconstructing from a prior sample
        and combining this with UNet features
        """
        if use_prior_mean:
            z_prior = self.prior_latent_space.mean
