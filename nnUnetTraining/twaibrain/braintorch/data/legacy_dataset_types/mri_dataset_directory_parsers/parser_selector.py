from .WMHChallenge import WMHChallengeDirParser
from .EdData import EdDataParser
from .MSS3_multirater import MSS3MultiRaterDataParser
from .LBC_multirater import LBCMultiRaterDataParser
from .WMHChallenge_Unified import WMHChallengeInterRaterDirParser
from .from_text_file import FromFileParser
import os
